...
'pegawai.destroy', $peg->id) }}" method="POST">
 <a class="btn btn-sm btnprimary " href="{{ route('pegawai.show',$peg->id) }}"><i class="fa fa-fw faeye"></i> Lihat</a>
 <a class="btn btn-sm btnsuccess" href="{{ route('pegawai.edit',$peg->id) }}"><i class="fa fa-fw faedit"></i> Ubah</a>
 @csrf
@method('DELETE')
